...
const app = express();
const pool=new pg({host:'ec2-3-222-150-253.compute-1.amazonaws.com',database:'d1qss0dq6iu5f4',user:'ckrkmkqcehleaa',password:'8301ee68b17ee9eb9c5eac5b4957330be174232d354f51d474470eb1ac7ae90e',port:'5432',ssl: { rejectUnauthorized: false }});
